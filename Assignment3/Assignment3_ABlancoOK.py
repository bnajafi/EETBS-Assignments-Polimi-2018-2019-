#ASSIGNMENT 3 (Example 1 Unit 1.2)
...
ResistanceList_withWood=[R_2,R_3,R_5,R_6,R_o,R_gap,R_i]
...
R_wood=ResistanceOfWall_wood(ResistanceList_withWood)
R_insulation=ResistanceOfWall_insulation(ResistanceList_withInsulation)
