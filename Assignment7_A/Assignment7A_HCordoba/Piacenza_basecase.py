...
windows_DF = pd.read_csv("input_fenestration_case2.csv",sep=";",index_col=0)
...
Uwindows_case = pd.read_csv("results_u_empty.csv",sep=";",index_col=0)     #put all the results in a data frame
Uwindows_case["Heating"]=windows_DF["U"]["East"]
Uwindows_case["Cooling"]=windows_DF["U"]["East"]
Uwindows_case.to_csv("u_windows_fenestration2.csv",sep=";")
#Final Results
...
results_DF.to_csv("results_wholeRFL_fen2.csv",sep =";")
